 \documentclass[empirical, author-date]{jote-article}
...
\end{filecontents}
\jotetitle{Systemic Problems in Academia: The Positive Publication Bias and Solutions from a Human Factors Perspective }
\keywordsabstract{academia}
\runningauthor{Gaillard \& Devine}
\jname{Journal of Trial and Error}
\jyear{2022}
\acknowledgments{The authors would like to thank Max Bautista Perpinyà for his substantial comments on the first draft, especially concerning the systemic approach, which led to a complete overhaul and ultimately improvement of the article.}
\funding{\undefined}
\doi{10.36850/ed3}
\jvolume{2}
\jissue{1}
\author[0]{Stefan Gaillard}{\orcid{https://orcid.org/0000-0003-1956-7325}}
\authorone{Stefan Gaillard}
\affil[1]{}
\corremail{\href{mailto:gaillard@centeroftrialanderror.com}{gaillard@centeroftrialanderror.com}}
\corraddress{}
\author[1]{Sean Devine}{\orcid{https://orcid.org/0000-0002-0445-2763}}
\authortwo{Sean Devine}
\affil[2]{}
\paperpublished{2022-02-28}
