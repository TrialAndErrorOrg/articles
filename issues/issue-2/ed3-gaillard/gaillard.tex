 \documentclass[editorial, authordate,twocolumn,issue]{jote-new-article}
...
\jyear{2022}
\acknowledgments{The authors would like to thank \href{https://oliviodare.com}{Max Bautista Perpinyà} for his substantial comments on the first draft, especially concerning the systemic approach, which led to a complete overhaul and ultimately improvement of the article.}
\paperdoi{10.36850/ed3}
\jvolume{2}
\jissue{1}
