 \documentclass[twocolumn,empirical, authordate,9]{jote-new-article}
...
\author[3]{Joshua Carlson}
\authorthree{Joshua Carlson}
\affil[3]{Northern Michigan University}
