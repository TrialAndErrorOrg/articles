...
% This package is for generating Lorem Ipsum, usage: \lipsum[X] where X is the Xth paragraph 
...
\jotetitle{Rewilding Cognition: Complex Dynamics in Open Experimental Systems}
